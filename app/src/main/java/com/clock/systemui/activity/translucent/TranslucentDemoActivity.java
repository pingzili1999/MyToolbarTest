...
public class TranslucentDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_translucent_all).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        } else if(viewId == R.id.btn_translucent_all) {
            Intent translucentBarIntent = new Intent(this, AllTranslucentActivity.class);
            startActivity(translucentBarIntent);
        }
    }
}
